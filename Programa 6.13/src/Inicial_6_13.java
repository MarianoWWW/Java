...
public class Inicial_6_13 {
    public static void main(String[] args) throws Exception {

        Scanner scanner = new Scanner(System.in);

        int día, mes, año, restar;
        boolean valida;
        ...
        System.out.println("Ahora escribime cuántos días queres restarle a la fecha, por favor : ");
        restar = scanner.nextInt();
        if (restar < 0) {
            restar = restar * (-1);
        }
        for (int k = 0; k < restar; k++) {
            scanner.close();
        ...
        System.out.println("Restándole " +(restar)+ " días a la fecha dada, queda : " + (día) + "/" + (mes) + "/" + (año));
